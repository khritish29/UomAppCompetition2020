package com.maurishop2911.adforest.home;
...
import com.maurishop2911.adforest.R;
import com.maurishop2911.adforest.SplashScreen;
import com.maurishop2911.adforest.ad_detail.Ad_detail_activity;
import com.maurishop2911.adforest.adapters.SpinnerAndListAdapter;
import com.maurishop2911.adforest.helper.LocaleHelper;
import com.maurishop2911.adforest.helper.MyAdsOnclicklinstener;
import com.maurishop2911.adforest.helper.WorkaroundMapFragment;
import com.maurishop2911.adforest.home.adapter.ItemEditImageAdapter;
import com.maurishop2911.adforest.home.helper.AdPostImageModel;
import com.maurishop2911.adforest.home.helper.CalanderTextModel;
import com.maurishop2911.adforest.home.helper.ProgressModel;
import com.maurishop2911.adforest.modelsList.myAdsModel;
import com.maurishop2911.adforest.modelsList.subcatDiloglist;
import com.maurishop2911.adforest.utills.Admob;
import com.maurishop2911.adforest.utills.AnalyticsTrackers;
import com.maurishop2911.adforest.utills.GPSTracker;
import com.maurishop2911.adforest.utills.Network.RestService;
import com.maurishop2911.adforest.utills.RuntimePermissionHelper;
import com.maurishop2911.adforest.utills.SettingsMain;
import com.maurishop2911.adforest.utills.UrlController;
...
public class AddNewAdPost extends AppCompatActivity implements OnMapReadyCallback,
        ...
        RuntimePermissionHelper.permissionInterface, LocationEngineCallback<LocationEngineResult>, com.mapbox.mapboxsdk.maps.OnMapReadyCallback, OnLocationClickListener, OnCameraTrackingChangedListener, PermissionsListener {
    ...
    CardView cardViewPriceInput, cardViewtBidingTimer, meraCardView;
...
//    }
    ...
    public class ViewDialog {
        ...
        public void showDialog(Activity activity, String msg) {
            ...
            Glide.with(AddNewAdPost.this).load(R.drawable.angry).into(imageView);
                                ...
                                if (position != 0) {
                                    ...
                                    if (parentView.getId() == 2222)
                                        if (!subcatDiloglistitem.isPaid()) {
                                            ...
                                            //alert.showDialog(context, "Please Buy the Package which has the category present in it");
//                                                ViewDialogMaterial alert =new ViewDialogMaterial();
                                    ...
                                    try {
                                        if (eachData.getBoolean("has_cat_template"))
                                            if (subcatDiloglistitem.isHasCustom()) {
                                                ...
                                                adforest_showCustom(eachData, subcatDiloglistitem, cardViewtBidingTimer, "nonDefault");
...
//                    if (eachData.getString("title").equals("Bidding")){
//                        meraCardView = cardView;
//                        meraCardView.setVisibility(View.GONE);
//                    }
...
//                    if (jsonObj.getJSONObject("map").getString("map_style").equals("google_map")) {
...
//                    }
                    if (!jsonObj.getJSONObject("map").getString("map_style").equals("map_box")) {
                        ...
                        mapView = findViewById(R.id.mapView);
                        mapView.getMapAsync(this);
//                            MapView mapBoxView = findViewById(R.id.mapBoxMap);
//                            mapBoxView.getMapAsync(new com.mapbox.mapboxsdk.maps.OnMapReadyCallback() {
//                                @Override
//                                public void onMapReady(@NonNull MapboxMap mapboxMap) {
//                                    mapBoxMap = mapboxMap;
//                                    mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
...
//                                options.camera(new com.mapbox.mapboxsdk.camera.CameraPosition.Builder()
//                                        .target(new com.mapbox.mapboxsdk.geometry.LatLng(-52.6885, -70.1395))
//                                        .zoom(9)
//                                        .build());
//
//// Create map fragment
//                                mapFragment = com.mapbox.mapboxsdk.maps.SupportMapFragment.newInstance(options);
//
//// Add map fragment to parent container
//                                transaction.add(R.id.container, mapFragment, "com.mapbox.map");
//                                transaction.commit();
//
////                                mapFragment = (com.mapbox.mapboxsdk.maps.SupportMapFragment) getSupportFragmentManager().findFragmentByTag("com.mapbox.map");
//
//                                if (mapFragment != null) {
